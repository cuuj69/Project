...
class UserDetail(models.Model):
	...
	STATE_CHOICES = (("Northen Region", 'Northen Region'), ("Ashanti Region", 'Ashanti Region'), ("Western Region", 'Western Region'), ("Volta Region", 'Volta Region'), ("Eastern Region", 'Eastern Region'), ("Upper West Region", 'Upper West Region'), ("Upper East Region", 'Upper East Region'), ("Central Region", 'Central Region'), ("Bono East Region", 'Bono East Region'), ("Greater Accra Region", 'Greater Accra Region'), ("Savannah Region", 'Savannah Region'), ("North-East Region", 'North-East Region'), ("Oti Region", 'Oti Region'), ("Western North Region", 'Western North Region'), ("Ahafo Region", 'Ahafo Region'), ("Bono Region", 'Bono Region')
		,
		)
